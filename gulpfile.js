...
const handlePHP = php.bind(null, isBuild);
...
function watcher() {
  ...
  //gulp.watch(filePaths.watch.php, handlePHP);
 ...
 * */
const devTasks = gulp.parallel(copy, copyRootFiles, createSvgSprite, handleHTML, /* handlePHP, */ handleSCSS, handleJS, handleImages);
